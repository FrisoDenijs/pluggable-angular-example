...
export class AppComponent implements AfterViewInit {
  ...
  constructor(private _compiler: Compiler, private _injector: Injector, private router: Router) { 
  ...
  private async loadPluginB() {
    // import external module bundle
    const module = await SystemJS.import("assets/plugins/plugin-b.bundle.js");

    // compile module
    const moduleFactory = await this._compiler
      .compileModuleAsync<any>(module["PluginBModule"]);
